...
`DynamicNUTS` is not appropriate for use in compositional inference. If you intend to use [Gibbs](https://turing.ml/dev/docs/library/#Turing.Inference.Gibbs) sampling, you must use Turing's native `NUTS` function.
