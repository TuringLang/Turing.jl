...
namespace beta_model_namespace {
...
class beta_model : public prob_grad {
private:
    int N;
    vector<int> y;
public:
    beta_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "beta_model_namespace::beta_model";
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "beta_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
typedef beta_model_namespace::beta_model stan_model;
