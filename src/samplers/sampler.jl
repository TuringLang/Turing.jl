...
assume{T<:Distribution}(spl::Nothing, dists::Vector{T}, vn::VarName, var::Any, vi::VarInfo) = begin
...
observe{T<:Distribution}(spl::Nothing, dists::Vector{T}, value::Any, vi::VarInfo) = begin
