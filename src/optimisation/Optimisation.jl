...
If `initial_params` is `nothing`, it is generated by either sampling from the prior
distribution or uniformly from the box constraints.
...
`initial_params` is the initial value for the optimization. If it is `nothing` or omitted it is
