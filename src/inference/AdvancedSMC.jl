...
(m::DynamicPPL.Model)(x::DynamicPPL.AbstractVarInfo)=first(evaluate!!(model, x)) 
(m::DynamicPPL.Model)(x::DynamicPPL.AbstractVarInfo, y::DynamicPPL.AbstractSampler)=first(evaluate!!(model, x, y))
(m::DynamicPPL.Model)(x::DynamicPPL.AbstractVarInfo, y::DynamicPPL.AbstractSampler, z::DynamicPPL.AbstractContext)=first(evaluate!!(model, x, y, z))
