...
@model lr begin
  beta = Vector{Dual}(3) # initialise an array to store means
  for i = 1:3
...
hmc_time_1 = [0.12774250507354737,0.14173009395599365,0.5516953945159913,1.0368835926055908]
...
hmc_time_2 = [0.028660011291503907,0.2859050989151001,1.4190002918243407,2.8486393213272097]
...
hmc_time_3 = [0.011547994613647462,0.13400509357452392,0.6510027170181274,1.0813661098480225]

# pg_time_1 = [0.2462191104888916,0.044436192512512206,0.16649439334869384,0.38031659126281736,0,0,0]

pg_time_1 = [0.2462191104888916,0.044436192512512206,0.16649439334869384,0.38031659126281736]

# pg_time_2 = [0.20912668704986573,0.06705899238586426,0.3262843132019043,0.7031997919082642, 0, 0, 0]

pg_time_2 = [0.20912668704986573,0.06705899238586426,0.3262843132019043,0.7031997919082642]
...
smc_time = [0.09754419326782227,0.0046575927734375,0.017091922760009766,0.03385972023010254]
...
draw(PDF("/Users/kai/Turing/docs/report/withinturinglr.pdf", 4inch, 4inch), p)
